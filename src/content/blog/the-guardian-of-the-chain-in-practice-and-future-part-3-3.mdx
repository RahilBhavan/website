...
**Context:** In [Part 1](/writing/the-guardian-of-the-chain-sleep-soundly-part-1-3/) we introduced the CLI and invariant-based replay; in [Part 2](/writing/the-guardian-of-the-chain-under-the-hood-part-2-3/) we walked through the Rust architecture. Here we run the **Euler Finance case study** step-by-step, interpret the outputs, and outline the roadmap.
...
- Read [Part 1: Sleep Soundly](/writing/the-guardian-of-the-chain-sleep-soundly-part-1-3/) and [Part 2: Under the Hood](/writing/the-guardian-of-the-chain-under-the-hood-part-2-3/) if you haven’t yet.
...
- [The Guardian of the Chain: Under the Hood (Part 2)](/writing/the-guardian-of-the-chain-under-the-hood-part-2-3/) — Rust architecture and workflow
