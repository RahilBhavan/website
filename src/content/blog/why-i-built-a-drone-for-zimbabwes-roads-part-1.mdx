...
#### Technical Components & BOM

Building a custom drone in Zimbabwe required a mix of high-end flight electronics and local rapid prototyping. Here's a look at the core components laid out before assembly.

![Drone Parts Layout Wide](/images/projects/pothole-drone/2024/06/drone-parts-layout-wide.jpg)
*The complete Bill of Materials (BOM) for the pothole detection drone, including the Cube Orange, Raspberry Pi 5, and custom frame components.*

![Drone Parts Layout Top View](/images/projects/pothole-drone/2024/06/drone-parts-layout-top.jpg)
*Organizing the electronics: ESCs, flight controller, and power distribution board ready for integration.*
...
*The final iteration of the drone frame on display at ZITF. This build features the custom CNC aluminum build plate for rigidity and 3D printed components for sensor mounting and vibration dampening.*
